      ...
      <div className="w-full">
        <div className="w-full mx-auto px-5 md:px-8 py-12 lg:py-14">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8">
            {/* Brand Column */}
            <div className="lg:col-span-4 lg:border-r lg:border-slate-200 lg:pr-8">
            ...
            <div className="lg:col-span-12 border border-slate-200 rounded-xl">
              <div className="px-5 md:px-8 py-8 flex flex-col items-center justify-center gap-6">
        ...
        <div className="w-full mx-auto px-5 md:px-8 py-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {trustFeatures.map((f, i) => (
              <div
                key={i}
                className="flex items-start gap-3 lg:border-r lg:border-slate-200"
              >
      ...
      <div className="w-full bg-[#111827] text-white">
        <div className="w-full mx-auto px-5 md:px-8 py-8">
          <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6 lg:gap-8">
            ...
            {/* Center — Nav Links */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-x-5 gap-y-2 text-gray-400 text-[13px]">
