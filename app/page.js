  ...
  <style jsx global>{`
    ...
    * {
    ...
    .blob-purple {
      ...
      animation:
        blobMorph 15s ease-in-out infinite reverse,
        floatY 10s ease-in-out infinite 2s;
      filter: blur(40px);
      pointer-events: none;
    }
    ...
    .particle-2 {
      ...
      top: 28%;
      left: 18%;
      animation: particleDrift 8s ease-in-out infinite 1s;
    }
    .particle-3 {
      width: 8px;
      height: 8px;
    ...
    .particle-4 {
      ...
      top: 80%;
      left: 22%;
      animation: particleDrift 9s ease-in-out infinite 0.5s;
    }
    .particle-5 {
      width: 6px;
      height: 6px;
      ...
      top: 18%;
      right: 12%;
      animation: particleDrift 5s ease-in-out infinite 1.5s;
    }
    .particle-6 {
      width: 4px;
      height: 4px;
      ...
      top: 45%;
      right: 8%;
      animation: particleDrift 10s ease-in-out infinite 3s;
    }
    .particle-7 {
      width: 7px;
      height: 7px;
      ...
      top: 72%;
      right: 18%;
      animation: particleDrift 7s ease-in-out infinite 0.8s;
    }
    .particle-8 {
      width: 3px;
      height: 3px;
      ...
      top: 88%;
      right: 5%;
      animation: particleDrift 8s ease-in-out infinite 2.2s;
    }
    ...
    .c-ring-2 {
      ...
      animation: rotateSlow2 30s linear infinite;
    }
    .c-glow {
      width: 200px;
      height: 200px;
    ...
    .slide-in {
      animation: imgSlide 0.5s cubic-bezier(0.22, 1, 0.36, 1) both;
    }
...
const Page = () => {
  ...
  const scrollCatLeft = () => {
    categoryRef.current?.scrollBy({ left: -220, behavior: "smooth" });
    setCatIndex((p) => Math.max(p - 1, 0));
  };
  const scrollCatRight = () => {
    categoryRef.current?.scrollBy({ left: 220, behavior: "smooth" });
    setCatIndex((p) => Math.min(p + 1, totalDots - 1));
  };
    ...
    <div className="font-sans bg-white min-h-screen">
      ...
      <section className="hero-bg w-full px-4 sm:px-8 md:px-12 lg:px-16 pt-[100px] pb-8 sm:pt-[110px] sm:pb-10 md:pt-[120px] md:pb-14 -mt-[80px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-center max-w-7xl mx-auto relative z-10">
          ...
          <div className="hidden md:block order-1 md:order-2 anim-scale-in delay-300">
            {" "}
