...
const FEATURES = [
  {
    icon: GraduationCap,
    title: "Find Expert Trainers",
    desc: "Browse thousands of verified trainers across every subject, skill, and exam.",
    color: "#4f46e5",
    bg: "#eef2ff",
  },
  {
    ...
    desc: "Stay on top of entrance exams, cut-offs, eligibility, and important dates.",
    color: "#7c3aed",
    bg: "#f5f3ff",
  },
  {
    ...
    desc: "Explore curated courses, specialisations, and career paths aligned with your goals.",
    color: "#2563eb",
    bg: "#eff6ff",
  },
  {
    ...
    desc: "Get personalised advice and career tips from experienced mentors.",
    color: "#0891b2",
    bg: "#ecfeff",
  },
];
...
function TeamCard({ member, onClick }) {
  ...
  return (
    ...
    >
      ...
      {/* CONTENT SECTION */}
      <div
        style={{ padding: "20px 22px 24px", borderTop: "1px solid #f1f5f9" }}
      >
        <h3
          style={{
            fontFamily: "'Poppins',sans-serif",
  ...
  return (
    <div
      ...
      style={{
        ...
        justifyContent: "center",
        padding: 20,
        animation: "tt-fadeIn .22s ease both",
      }}
    >
      <div
        onClick={(e) => e.stopPropagation()}
        ...
        style={{
          ...
          animation: "tt-modalUp .4s cubic-bezier(.22,1,.36,1) both",
          display: "grid",
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(to bottom, transparent 38%, rgba(6,12,48,0.85) 100%)",
              zIndex: 3,
            }}
          />
          <div
        ...
        >
          <div>
            ...
            <div
              style={{
                width: 44,
                height: 3,
                background: `linear-gradient(90deg,${B},${PUR})`,
                borderRadius: 2,
                marginBottom: 20,
              }}
            />
          ...
          <a
            ...
            style={{
              ...
              justifyContent: "center",
              gap: 10,
              background: `linear-gradient(135deg,${B},${PUR})`,
              color: "#fff",
              padding: "14px 24px",
              borderRadius: 50,
              fontWeight: 700,
    ...
    <div style={{ position: "relative", width: "100%", maxWidth: 500 }}>
      <div
        style={{
          ...
          overflow: "hidden",
          boxShadow:
            "0 40px 100px rgba(79,70,229,0.22), 0 16px 40px rgba(99,102,241,0.14)",
          border: "1px solid rgba(255,255,255,0.9)",
          background: "#fff",
          animation: "tt-float 7s ease-in-out infinite",
        }}
      >
        <div
          style={{
        ...
        <div style={{ padding: "22px 26px 26px" }}>
          {[
            ["1,200+", "Verified Trainers", "#eef2ff", "#4f46e5"],
            ["200+", "Skill Categories", "#f5f3ff", "#7c3aed"],
            ["98%", "Student Satisfaction", "#f0fdf4", "#16a34a"],
          ].map(([val, lbl, bg, col]) => (
            <div
              key={lbl}
              style={{
      ...
      <div
        style={{
          ...
          borderRadius: 18,
          padding: "12px 16px",
          boxShadow: "0 16px 44px rgba(79,70,229,0.2)",
          border: "1px solid rgba(99,102,241,0.15)",
          display: "flex",
          alignItems: "center",
          gap: 10,
          fontFamily: "'Poppins',sans-serif",
          animation: "tt-float 5.5s ease-in-out infinite 1s",
        }}
      >
        <div
          style={{
      ...
      <div
        style={{
          ...
          borderRadius: 18,
          padding: "12px 16px",
          boxShadow: "0 16px 44px rgba(124,58,237,0.18)",
...
export default function AboutPage() {
  ...
  const onDragMove = (x) => {
    if (isDragging) setDragDelta(x - dragStart);
  };
  const onDragEnd = () => {
...
.tt-about *, .tt-about *::before, .tt-about *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      <section className="tt-hero">
        ...
        <div className="tt-hero-inner">
          <div>
            ...
            >
              TopTrainer is India's trusted platform where students discover
              verified, experienced trainers across every subject, skill, and
              competitive exam — and where trainers showcase their expertise to
              thousands of eager learners.
            </p>

            <div
              className="tt-fadeup tt-d4"
            ...
            >
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translateY(-3px)";
                  e.currentTarget.style.boxShadow =
                    "0 18px 44px rgba(79,70,229,0.52)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "none";
                  e.currentTarget.style.boxShadow =
                    "0 10px 32px rgba(79,70,229,0.38)";
                }}
              >
                Find a Trainer <ArrowUpRight size={16} />
              </a>
              <a
                href="/courses"
                style={{
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow =
                    "0 8px 26px rgba(99,102,241,0.18)";
          ...
          <div
            className="tt-hero-right tt-scaleIn tt-d3"
        ...
        <div className="tt-feat-grid">
          {FEATURES.map((f, i) => {
            ...
            return (
              <div
                key={f.title}
                className={`tt-feat-card tt-fadeup tt-d${i + 2}`}
              >
      ...
      <section style={{ background: "#fff", padding: "72px 0 0" }}>
        <div className="tt-about-grid">
          <div>
            ...
            >
              TopTrainer is India's leading platform for finding verified
              trainers. Whether you're preparing for a competitive exam,
              learning a new skill, or planning your career — we have the right
              mentor for you.
            </p>
            <p
              style={{
            ...
            >
              Trainers showcase their expertise, students find the perfect
              match, and learning happens seamlessly in one trusted space.
            </p>
            <div>
              {CHECKLIST.map((item) => (
                <div key={item} className="tt-check-row">
                  <CheckCircle
                    size={18}
                    color={B}
                    fill={BL}
          ...
          <div>
            <div
              style={{
                background: `linear-gradient(135deg,${BL},#dbeafe)`,
                border: `1px solid ${BM}`,
                borderRadius: 26,
                padding: "42px 38px",
                position: "relative",
            ...
            >
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    justifyContent: "space-between",
                    padding: "14px 0",
                    borderBottom: "1px solid rgba(79,70,229,.1)",
                    fontFamily: "'Poppins',sans-serif",
                  }}
                >
                  <span
                  ...
                  <span style={{ fontSize: 22, fontWeight: 900, color: B }}>
                    {stat}
                  </span>
                </div>
              ))}
              ...
              >
                "Our mission is to empower every student with the right trainer
                and guidance to build a successful future."
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div>
              ...
              >
                The people behind <span className="tt-shimmer">TopTrainer</span>
              </h2>
              <p
                style={{
                  fontSize: 15,
              ...
              >
                Meet the creators, developers, and visionaries building the
                future of trainer discovery and online learning.
              </p>
            </div>
            <div
              style={{
            ...
            >
              ...
              <button
                ...
                style={{
                  ...
                  color: "#fff",
                  border: "none",
                  boxShadow: "0 8px 24px rgba(79,70,229,.38)",
                }}
                onClick={() => {
                  goNext();
                  stopAuto();
          ...
          >
            ...
            <div
              ...
              style={{
                position: "relative",
                zIndex: 1,
                transform: `translateX(${isDragging ? dragDelta * 0.09 : 0}px)`,
                transition: isDragging ? "none" : "transform .32s ease",
                animation: "tt-carIn .4s cubic-bezier(.22,1,.36,1) both",
              }}
            >
              <TeamCard
                member={TEAM[carouselIndex]}
                onClick={() =>
                  !isDragging &&
                  Math.abs(dragDelta) < 8 &&
                  setModalMember(TEAM[carouselIndex])
                }
              />
            </div>
          </div>
            ...
            {TEAM.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  background: i === carouselIndex ? B : BM,
                }}
              />
            ))}
          </div>
            ...
            {TEAM.map((m, i) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: 40,
                  border: `1.5px solid ${i === carouselIndex ? B : "#e2e8f0"}`,
                  background: i === carouselIndex ? BL : "#fff",
                  cursor: "pointer",
                  transition: "all .28s",
                  fontFamily: "'Poppins',sans-serif",
                }}
              >
                ...
                <span
                  style={{
                    fontSize: 12,
                    fontWeight: 600,
                    color: i === carouselIndex ? B : "#64748b",
                    whiteSpace: "nowrap",
                  }}
                >
                  {m.name.split(" ")[0]}
