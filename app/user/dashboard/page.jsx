...
const videos = [
  {
    id: "bAulddz4q94",
    title:
      "How I leveled up as a Full Stack Developer | Paras Kumar | IREED India",
    views: "9.8K views",
  },
  {
    id: "xA7AWhLQXKQ",
    ...
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <div className="flex -space-x-3 mb-6 px-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <img
                  key={i}
                  src={`https://i.pravatar.cc/150?u=trainer${i}`}
                  alt="Trainer"
          ...
          <Link
            href="#"
            className="text-indigo-600 text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all w-fit"
          >
            ...
            <div className="space-y-4 mb-4">
              <div className="flex gap-4 items-center">
                ...
                <h3 className="text-sm font-bold text-slate-800 leading-tight">
                  5 Leadership Lessons Every Manager Should Know
                </h3>
              </div>
              <div className="flex gap-4 items-center">
                <img
              ...
              <div className="flex gap-4 items-center">
                <img
                  src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=150&h=150&fit=crop"
                  alt="Article"
                  className="w-14 h-12 rounded-lg object-cover"
                />
                <h3 className="text-sm font-bold text-slate-800 leading-tight">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between">
              ...
              {[
                ...
                <div key={i} className="flex gap-5 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 mb-0.5 mt-0.5">
                      by {w.author}
                    </p>
          ...
          <Link
            href="#"
            className="text-indigo-600 text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all w-fit mt-2"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <p className="text-[13px] text-slate-500">
                  Let us know what you need, and we'll suggest the best trainers
                  for you.
                </p>
              </div>
            ...
            <div className="flex flex-wrap md:flex-nowrap justify-between items-start pt-5 border-t border-slate-100 gap-4 md:gap-0">
              <div className="flex flex-col gap-1.5 w-full md:w-1/5">
                ...
                <span className="text-[11px] text-slate-400 pl-7">
                  Specify your training goals
                </span>
              </div>
              <div className="flex flex-col gap-1.5 w-full md:w-1/5">
                <div className="flex items-center gap-2 text-slate-700 font-semibold text-[13px]">
                  <Monitor className="w-[18px] h-[18px] text-slate-400" />{" "}
                  Preferred Mode
                </div>
                <span className="text-[11px] text-slate-400 pl-7">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-8 flex-1">
            <div className="w-full md:w-[200px] flex-shrink-0 flex flex-col justify-center border-b md:border-b-0 md:border-r border-slate-100 pb-6 md:pb-0 md:pr-6">
              ...
              <p className="text-[11px] text-slate-500 mb-4 leading-relaxed">
                Helping us understand your needs helps us suggest the most
                relevant trainers.
              </p>
              <Link
                href="#"
            ...
            <div className="flex-1 grid grid-cols-1 sm:grid-cols-[1fr_1.2fr] gap-x-6 gap-y-5 content-center py-2">
              ...
              <div className="row-span-3">
                <span className="text-[13px] font-bold text-slate-900 block mb-3">
                  Skills of Interest
                </span>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={skill}
                      className="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-[11px] font-semibold"
                    >
                      {skill}
                    </span>
                  ))}
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between h-full">
          <div>
            ...
            <p className="text-[12px] text-slate-500 mb-6 mt-0.5">
              ...
              {[
                ...
                >
                  <div className="flex gap-3">
                    <img
                      src={`https://i.pravatar.cc/150?u=rec${t.img}`}
                      alt={t.name}
                      className="w-11 h-11 rounded-lg object-cover"
                    />
                    <div>
                      <h3 className="text-[13px] font-bold text-slate-900 group-hover:text-indigo-600 transition-colors">
                        {t.name}
                      </h3>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 text-center">
            <Link
              href="#"
              className="text-indigo-600 text-sm font-semibold inline-flex items-center gap-1 hover:gap-2 transition-all"
            >
      ...
      <div className="mb-8 bg-white p-4 rounded-2xl border border-slate-100 shadow-sm">
        <p className="text-sm md:text-lg md:font-bold lg:text-xl p-1 mb-4">
